                ...
                <div class="homeslider">
                    <div class="content-slide">
                        <ul id="contenhomeslider">
                          <li><img alt="Funky roots" src="/yc./Application/Home/Public/Images/icon_index/data/slider1.jpg" title="花菜" /></li>
                          <li><img alt="Funky roots" src="/yc./Application/Home/Public/Images/icon_index/data/slider2.jpg" title="红萝卜" /></li>
                          <li><img  alt="Funky roots" src="/yc./Application/Home/Public/Images/icon_index/data/slider3.jpg" title="黄瓜" /></li>
                          <li><img  alt="Funky roots" src="/yc./Application/Home/Public/Images/icon_index/data/slider4.jpg" title="茄子" /></li>
                          <li><img  alt="Funky roots" src="/yc./Application/Home/Public/Images/icon_index/data/slider5.jpg" title="四季豆" /></li>
                        	<li><img  alt="Funky roots" src="/yc./Application/Home/Public/Images/icon_index/data/slider6.jpg" title="丝瓜" /></li>
                        </ul>
                    </div>
                </div>
                <div class="header-banner banner-opacity">
                    <a href="#"><img alt="Funky roots" src="/yc./Application/Home/Public/Images/icon_index/data/slider7.jpg" /></a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-9 page-top-left">
                <div class="popular-tabs">
                      <ul class="nav-tab">
                        <li class="active"><a data-toggle="tab" href="#tab-1">新疆特产</a></li>
...
<div class="content-page">
    ...
    <!-- 蔬菜 -->
            <!-- featured category 蔬菜 -->
        <div class="category-featured">
            <nav class="navbar nav-menu nav-menu-red show-brand">
              <div class="container">
                <!-- Brand and toggle get grouped for better mobile display -->
                  <div class="navbar-brand"><a href="#"><img alt="fashion" src="/yc./Application/Home/Public/Images/icon_index/data/fashion.png" />蔬菜</a></div>
                  <span class="toggle-menu"></span>
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse">           
                  <ul class="nav navbar-nav">
                    <li class="active"><a data-toggle="tab" href="#tab-4">热销</a></li>
                    <li><a data-toggle="tab" href="#tab-5">团购</a></li>
                    <li><a href="#">女人最爱</a></li>
                    <li><a href="#">男人最爱</a></li>
                    <li><a href="#">美肤</a></li>
                    <li><a href="#">养生</a></li>
	   ...
	   <!-- featured category sports -->
        <div class="category-featured">
            <nav class="navbar nav-menu nav-menu-green show-brand">
              <div class="container">
                <!-- Brand and toggle get grouped for better mobile display -->
                  <div class="navbar-brand"><a href="#"><img alt="fashion" src="/yc./Application/Home/Public/Images/icon_index/data/sports.png" />水果</a></div>
                  <span class="toggle-menu"></span>
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse">           
                  <ul class="nav navbar-nav">
                    <li class="active"><a data-toggle="tab" href="#tab-6">热销</a></li>
                    <li><a data-toggle="tab" href="#tab-7">团购</a></li>
                    <li><a href="#">女人最爱</a></li>
                    <li><a href="#">男人最爱</a></li>
                    <li><a href="#">美肤</a></li>
                    <li><a href="#">养生</a></li>
    ...
    <!-- 五谷 -->
        ...
        <div class="category-featured">
            <nav class="navbar nav-menu nav-menu-orange show-brand">
              <div class="container">
                <!-- Brand and toggle get grouped for better mobile display -->
                  <div class="navbar-brand"><a href="#"><img alt="fashion" src="/yc./Application/Home/Public/Images/icon_index/data/electronic.png" />五谷</a></div>
                  <span class="toggle-menu"></span>
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse">           
                  <ul class="nav navbar-nav">
                    <li class="active"><a data-toggle="tab" href="#tab-8">热销</a></li>
                    <li><a data-toggle="tab" href="#tab-9">团购</a></li>
                    <li><a href="#">女人最爱</a></li>
                    <li><a href="#">男人最爱</a></li>
                    <li><a href="#">美肤</a></li>
                    <li><a href="#">养生</a></li>
                                ...
                                <ul class="product-list owl-carousel"  data-dots="false" data-loop="true" data-nav="true" data-margin = "0" data-autoplayTimeout="1000" data-autoplayHoverPause = "true" data-responsive='{"0":{"items":1},"600":{"items":3},"1000":{"items":4}}'>
                                    <li>
                                        <div class="left-block">
                                            ...
                                            <div class="add-to-cart">
                                                <a title="Add to Cart" href="#">���빺�ﳵ</a>
                                            </div>
                                        </div>
                                        <div class="right-block">
                                            <h5 class="product-name"><a href="#">Maecenas consequat mauris</a></h5>
    ...
    <!-- 花卉 -->
        ...
        <div class="category-featured">
            <nav class="navbar nav-menu nav-menu-blue show-brand">
              <div class="container">
                <!-- Brand and toggle get grouped for better mobile display -->
                  <div class="navbar-brand"><a href="#"><img alt="fashion" src="/yc./Application/Home/Public/Images/icon_index/data/digital.png" />花卉</a></div>
                  <span class="toggle-menu"></span>
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse">           
                  <ul class="nav navbar-nav">
                    <li class="active"><a data-toggle="tab" href="#tab-10">热销</a></li>
                    <li><a data-toggle="tab" href="#tab-11">团购</a></li>
                    <li><a href="#">女人最爱</a></li>
                    <li><a href="#">男人最爱</a></li>
                    <li><a href="#">美肤</a></li>
                    <li><a href="#">养生</a></li>
    ...
    <!-- 园林 -->
        ...
        <div class="category-featured">
            <nav class="navbar nav-menu nav-menu-blue2 show-brand">
              <div class="container">
                <!-- Brand and toggle get grouped for better mobile display -->
                  <div class="navbar-brand"><a href="#"><img alt="fashion" src="/yc./Application/Home/Public/Images/icon_index/data/furniture.png" />园林</a></div>
                  <span class="toggle-menu"></span>
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse">           
                  <ul class="nav navbar-nav">
                    <li class="active"><a data-toggle="tab" href="#tab-12">热销</a></li>
                    <li><a data-toggle="tab" href="#tab-13">团购</a></li>
                    <li><a href="#">女人最爱</a></li>
                    <li><a href="#">男人最爱</a></li>
                    <li><a href="#">美肤</a></li>
                    <li><a href="#">养生</a></li>
    ...
    <!-- 药材 -->
        ...
        <div class="category-featured">
            <nav class="navbar nav-menu nav-menu-blue2 show-brand">
              <div class="container">
                <!-- Brand and toggle get grouped for better mobile display -->
                  <div class="navbar-brand"><a href="#"><img alt="fashion" src="/yc./Application/Home/Public/Images/icon_index/data/furniture.png" />药材</a></div>
                  <span class="toggle-menu"></span>
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse">           
                  <ul class="nav navbar-nav">
    ...
    <!-- 家禽 -->
        ...
        <div class="category-featured">
            <nav class="navbar nav-menu nav-menu-blue2 show-brand">
              <div class="container">
                <!-- Brand and toggle get grouped for better mobile display -->
                  <div class="navbar-brand"><a href="#"><img alt="fashion" src="/yc./Application/Home/Public/Images/icon_index/data/furniture.png" />家禽</a></div>
                  <span class="toggle-menu"></span>
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse">           
                  <ul class="nav navbar-nav">
    ...
    <!-- 畜牧 -->
        ...
        <div class="category-featured">
            <nav class="navbar nav-menu nav-menu-blue2 show-brand">
              <div class="container">
                <!-- Brand and toggle get grouped for better mobile display -->
                  <div class="navbar-brand"><a href="#"><img alt="fashion" src="/yc./Application/Home/Public/Images/icon_index/data/furniture.png" />畜牧</a></div>
                  <span class="toggle-menu"></span>
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse">           
                  <ul class="nav navbar-nav">
    ...
    <!-- 水产 -->
        ...
        <div class="category-featured">
            <nav class="navbar nav-menu nav-menu-gray show-brand">
              <div class="container">
                <!-- Brand and toggle get grouped for better mobile display -->
                  <div class="navbar-brand"><a href="#"><img alt="fashion" src="/yc./Application/Home/Public/Images/icon_index/data/jewelry.png" />水产</a></div>
                  <span class="toggle-menu"></span>
                <!-- Collect the nav links, forms, and other content for toggling -->
                <div class="collapse navbar-collapse">           
                  <ul class="nav navbar-nav">
                    <li class="active"><a data-toggle="tab" href="#tab-14">热销</a></li>
                    <li><a data-toggle="tab" href="#tab-15">团购</a></li>
                    <li><a href="#">渤海</a></li>
                    <li><a href="#">黄海</a></li>
                    <li><a href="#">东海</a></li>
                    <li><a href="#">南海</a></li>
