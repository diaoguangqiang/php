...
?>     
  <div class="Index_foot_NR">
      ...
      <ul>
          <?php $_from = $this->_var['help_cat']['article']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'item_0_61649100_1442210986');if (count($_from)):
    foreach ($_from AS $this->_var['item_0_61649100_1442210986']):
?>
          <li style="position: relative;"><a href="<?php echo $this->_var['item_0_61649100_1442210986']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['item_0_61649100_1442210986']['title']); ?>"><?php echo $this->_var['item_0_61649100_1442210986']['short_title']; ?></a></li>
...
<div class="Index_foot_black"> 
   ...
   <?php $_from = $this->_var['navigator_list']['bottom']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'nav_0_61673700_1442210986');$this->_foreach['nav_bottom_list'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['nav_bottom_list']['total'] > 0):
    foreach ($_from AS $this->_var['nav_0_61673700_1442210986']):
        $this->_foreach['nav_bottom_list']['iteration']++;
?>
        <a href="<?php echo $this->_var['nav_0_61673700_1442210986']['url']; ?>" <?php if ($this->_var['nav_0_61673700_1442210986']['opennew'] == 1): ?> target="_blank" <?php endif; ?>><?php echo $this->_var['nav_0_61673700_1442210986']['name']; ?></a>
