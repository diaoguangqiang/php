...
<div class="block clearfix"> 
 <?php echo $this->fetch('library/ur_here.lbi'); ?>
  ...
  <div class="AreaL">
<?php echo $this->fetch('library/help_center.lbi'); ?>
    ...
    <div class="box">
     <div class="box_1">
      <div style="border:4px solid #f8f8f8; background-color:#fff; padding:20px 15px;">
         ...
         <font class="f5 f6" style="font-size:14px; color:#333"><?php echo htmlspecialchars($this->_var['article']['title']); ?></font><br /><font class="f3"><?php echo htmlspecialchars($this->_var['article']['author']); ?> / <?php echo $this->_var['article']['add_time']; ?></font>
         </div>
         <?php if ($this->_var['article']['content']): ?>
          <?php echo $this->_var['article']['content']; ?>
         <?php endif; ?>
         <?php if ($this->_var['article']['open_type'] == 2 || $this->_var['article']['open_type'] == 1): ?><br />
         <div><img src="themes/hd/images/biao2.gif" /> <a href="<?php echo $this->_var['article']['file_url']; ?>" target="_blank"><?php echo $this->_var['lang']['relative_file']; ?></a></div>
          <?php endif; ?>
