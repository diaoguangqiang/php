...
<!-- 品牌搜索 -->
<?php echo $this->fetch('ecyclasspic_search.htm'); ?>
...
?>
    <tr>
      ...
      <td>
      <?php if ($this->_var['brand']['pclassid'] == 1): ?>幻灯片<?php endif; ?>
      <?php if ($this->_var['brand']['pclassid'] == 2): ?>幻灯片下图1<?php endif; ?>
      <?php if ($this->_var['brand']['pclassid'] == 3): ?>幻灯片下图2<?php endif; ?>
      <?php if ($this->_var['brand']['pclassid'] == 4): ?>幻灯片下滚动图片<?php endif; ?>
      </td>
      <td class="first-cell">
      ...
      <td align="center">
        <a href="ecy_classpic.php?act=edit&id=<?php echo $this->_var['brand']['brand_id']; ?>" title="<?php echo $this->_var['lang']['edit']; ?>"><?php echo $this->_var['lang']['edit']; ?></a> |
